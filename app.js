<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .modal-item-num { font-size: 0.88rem !important; }
  ...
  /* ── My Collection List: fixed column layout so Description fills space ── */
  #page-browse .item-table.collection-view { table-layout: fixed; }
  #page-browse .item-table.collection-view th:nth-child(1),
  #page-browse .item-table.collection-view td:nth-child(1) { width: 90px; }
  #page-browse .item-table.collection-view th:nth-child(2),
  #page-browse .item-table.collection-view td:nth-child(2) { width: 105px; }
  #page-browse .item-table.collection-view th:nth-child(3),
  #page-browse .item-table.collection-view td:nth-child(3) { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  #page-browse .item-table.collection-view th:nth-child(4),
  #page-browse .item-table.collection-view td:nth-child(4) { width: 290px; }
