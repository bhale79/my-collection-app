...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1778';/.test(sw));
ok('index.html stamps every asset at 1768 and none at 1767', (ix.match(/\?v=1768/g) || []).length === 79 && !/\?v=1767/.test(ix));
