...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1775';/.test(sw));
ok('index.html stamps every asset at 1765 and none at 1764', (ix.match(/\?v=1765/g) || []).length === 79 && !/\?v=1764/.test(ix));
