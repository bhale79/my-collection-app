...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1787';/.test(sw));
ok('index.html stamps every asset at 1777 and none at 1776', (ix.match(/\?v=1777/g) || []).length === 79 && !/\?v=1776/.test(ix));
