...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1776';/.test(sw));
ok('index.html stamps every asset at 1766 and none at 1765', (ix.match(/\?v=1766/g) || []).length === 79 && !/\?v=1765/.test(ix));
