...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1771';/.test(sw));
ok('index.html stamps every asset at 1761 and none at 1760', (ix.match(/\?v=1761/g) || []).length === 79 && !/\?v=1760/.test(ix));
