...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1791';/.test(sw));
ok('index.html stamps every asset at 1781 and none at 1780', (ix.match(/\?v=1781/g) || []).length === 79 && !/\?v=1780/.test(ix));
