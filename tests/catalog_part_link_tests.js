...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1790';/.test(sw));
ok('index.html stamps every asset at 1780 and none at 1779', (ix.match(/\?v=1780/g) || []).length === 79 && !/\?v=1779/.test(ix));
