...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1786';/.test(sw));
ok('index.html stamps every asset at 1776 and none at 1775', (ix.match(/\?v=1776/g) || []).length === 79 && !/\?v=1775/.test(ix));
