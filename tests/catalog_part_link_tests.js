...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1788';/.test(sw));
ok('index.html stamps every asset at 1778 and none at 1777', (ix.match(/\?v=1778/g) || []).length === 79 && !/\?v=1777/.test(ix));
