...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1789';/.test(sw));
ok('index.html stamps every asset at 1779 and none at 1778', (ix.match(/\?v=1779/g) || []).length === 79 && !/\?v=1778/.test(ix));
