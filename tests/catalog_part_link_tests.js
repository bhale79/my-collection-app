...
ok('CACHE_NAME is the version + 10', /const CACHE_NAME = 'mca-v1774';/.test(sw));
ok('index.html stamps every asset at 1764 and none at 1763', (ix.match(/\?v=1764/g) || []).length === 79 && !/\?v=1763/.test(ix));
