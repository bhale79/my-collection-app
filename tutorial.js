    ...
    'add-item': {
      ...
      steps: [
        ...
        { title: 'Full vs Quick Entry',
          msg: '<strong>Quick Entry</strong> saves immediately with no further questions — items are marked ⚡ so you can fill details in later. Choose <strong>Full Entry</strong> to walk through all the fields now.' },
        { title: 'Condition',
        ...
        { title: 'Add Photos',
          msg: 'Attach photos here. On a <strong>computer</strong>, click to upload from your files. On the <strong>mobile app</strong>, take a photo directly with your camera. Tap <strong>Next</strong> to skip and add photos later from the item\'s detail screen.' },
        { title: 'Review & Save',
          msg: 'The confirm screen shows every field you\'ve entered. <strong>Tap any line to edit it</strong> before saving. When you\'re happy, tap <strong>Save</strong> — the item is written to your Google Sheet instantly. That\'s it!' }
      ]
    },
  ...
  if (!isOpen) {
    setTimeout(() => {
      document.addEventListener('click', function _close(e) {
        if (!menu.contains(e.target) && !document.getElementById('tut-help-widget').contains(e.target)) {
